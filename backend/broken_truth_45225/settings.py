"""
Django settings for broken_truth_45225 project.
...
ROOT_URLCONF = 'broken_truth_45225.urls'
...
WSGI_APPLICATION = 'broken_truth_45225.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_truth_45225 API",
    "DESCRIPTION": "API documentation for broken_truth_45225 App",
    "VERSION": "v1",
}
